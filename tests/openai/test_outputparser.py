...
class TestScratchpadParser(unittest.TestCase):
    ...
    def test_get_actions_with_multiple_actions(self):
        ...
        self.assertEqual(
            ScratchpadParser.get_actions(scratchpad),
            ["{action_data1}", "{action_data2}"],
        )
    ...
    def test_get_observations_with_multiple_observations(self):
        ...
        self.assertEqual(
            ScratchpadParser.get_observations(scratchpad),
    ...
    def test_get_thoughts_with_multiple_thoughts(self):
        ...
        self.assertEqual(
            ScratchpadParser.get_thoughts(scratchpad), [" Thought 1", " Thought 2"]
        )
