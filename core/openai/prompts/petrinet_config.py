PETRINET_PROMPT = """
      ...
      If a condition is not mentioned in the research paper, then the value should be set to the string "null". Be sure to use consistent naming conventions for the conditions.
